...
export const buildTeamEntityFromTeam = (team: Team): TeamEntity =>
  new TeamEntity({ name: team.name, team_id: team.teamId, group: team.group ?? 1 });
...
export const teams: Team[] = [
  { name: 'one', teamId: '62eec995-bda0-47df-86cb-d412b25a8d03', group: 1 },
  { name: 'two', teamId: '0272aa8a-3eca-41d8-9bbf-f165c34ab276', group: 1 },
  { name: 'three', teamId: 'f27a4207-54cf-428e-a62a-01e914d6a75f', group: 1 },
  { name: 'four', teamId: '358cad12-0a04-4b98-8790-f7a51b5ebd07', group: 1 },
  { name: 'five', teamId: '354f48ca-7eea-4869-a084-d80601d1c050', group: 1 },
  { name: 'six', teamId: '0b1ac01a-95fc-4bb6-895e-e7cdb802dbab', group: 1 },
  { name: 'seven', teamId: 'b2d5c0d9-d696-4165-8933-c45c3548f6c3', group: 1 },
  { name: 'eight', teamId: '6b9890de-7979-4713-a0ed-b385baa275c0', group: 1 },
];
